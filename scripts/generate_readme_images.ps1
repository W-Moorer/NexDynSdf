...
Invoke-Checked $generator @(
    (Join-Path $repository 'tests/models/pycoco/sphere.obj'), $sphere,
...
Invoke-Checked $generator @(
    (Join-Path $repository 'tests/models/nagata/cone.nsm'), $cone,
...
Invoke-Checked $generator @(
    (Join-Path $repository 'tests/models/sdflib/Gear.obj'), $gear,
